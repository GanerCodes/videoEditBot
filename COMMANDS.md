...
| `wave`          | `wav`       | Number | 1    | 100          | Higher numbers mean faster waves.                                                                   |
| `waveamount`    | `wava`      | Number | 1    | 100          | Higher numbers mean more waves.                                                                     |
| `wavestrength`  | `wavs`      | Number | 1    | 100          | Higher numbers mean larger waves.                                                                   |
